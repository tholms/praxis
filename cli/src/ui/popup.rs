...
//
// Generic overlays (lists, confirms, cross-cutting dialogs). Domain
// edit forms live with their feature (operations/, intercept/,
// settings/) and share widgets via `form_modal`.
//
