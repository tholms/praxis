...
const TABLES: TableInfo[] = [
  ...
  },
  {
    ...
    description: 'Chain execution history with per-element state',
    source: 'Database',
    columns: [
      { name: 'timestamp', description: 'Creation time' },
      { name: 'execution_id', description: 'Chain execution ID' },
      { name: 'chain_id', description: 'Chain definition ID' },
      { name: 'chain_name', description: 'Chain display name' },
      { name: 'node_id', description: 'Executing node' },
      { name: 'agent_short_name', description: 'Executing agent' },
      { name: 'status', description: 'Queued, Running, Completed, Failed, Cancelled' },
      { name: 'elements', description: 'Per-element execution state (JSON)' },
      { name: 'outputs', description: 'Terminal element outputs (JSON)' },
      { name: 'started_at', description: 'Execution start time' },
      { name: 'ended_at', description: 'Execution end time' },
    ],
  },
  {
    name: 'SemanticOperationLogs',
    description: 'Semantic operation execution history',
    source: 'Database',
    columns: [
      { name: 'timestamp', description: 'Creation time' },
      ...
      { name: 'agent_short_name', description: 'Executing agent' },
      { name: 'status', description: 'Queued, Running, Completed, Failed, Cancelled' },
      { name: 'operation_spec', description: 'Full operation spec (JSON)' },
      { name: 'start_time', description: 'Operation start time' },
      { name: 'end_time', description: 'Operation end time' },
      { name: 'summary', description: 'Summary of actions taken' },
      { name: 'result', description: 'Output/findings' },
      { name: 'chain_execution_id', description: 'Parent chain ID (null if standalone)' },
    ],
  },
  {
    ...
    columns: [
      ...
      { name: 'id', description: 'Action ID' },
      { name: 'execution_id', description: 'Execution group ID' },
      { name: 'tool_name', description: 'Tool name' },
      { name: 'action', description: 'Action performed' },
      { name: 'status', description: 'Action status' },
      { name: 'node_id', description: 'Target node' },
      { name: 'agent_short_name', description: 'Target agent' },
      { name: 'session_id', description: 'Session ID' },
      { name: 'details_json', description: 'Action details (JSON)' },
    ],
  },
  {
    name: 'TrafficLogs',
