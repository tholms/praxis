...
pub fn to_common(e: database::ChainElement) -> common::ChainElement {
    match e {
        database::ChainElement::Trigger { id, trigger_type } => common::ChainElement::Trigger {
            id,
        ...
        database::ChainElement::Memory { id, key, mode } => common::ChainElement::Memory {
            id,
            key,
            mode: match mode {
...
pub fn to_database(e: common::ChainElement) -> database::ChainElement {
    match e {
        common::ChainElement::Trigger { id, trigger_type } => database::ChainElement::Trigger {
            id,
            trigger_type: match trigger_type {
        ...
        common::ChainElement::Memory { id, key, mode } => database::ChainElement::Memory {
            id,
            key,
            mode: match mode {
